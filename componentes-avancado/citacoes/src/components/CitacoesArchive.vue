<template>
    <div class="citacoes">
        ...
        <Citacao>
            <!-- A tag slot dentro de CitacaoArchive me permite passar todo esse corpo de texto dentro do meu arquivo Citacao -->
            <h1 slot="autor"> {{citacoes[indice].autor}}</h1>
            <p slot>{{citacoes[indice].texto}}</p>
...
<script>
import Citacao from "./CitacaoArchive"
